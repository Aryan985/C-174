AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    nucleusname.setAttribute("position", { x: 0, y: 0.5, z: 0 });
...
var angle2 = 30
    for (var i=0;i<numOfElectron;i++){
      ...
      orbit.setAttribute("material",{color:"grey"})
  
      orbit.setAttribute("position", { x: 0, y: 1, z: 0 });
      orbit.setAttribute("rotation", { x: 0, y: angle, z: 0 });
      ...
      group.setAttribute('rotation',{x:0,y:0,z:angle2})
      ...
      electron.setAttribute("material",{color:"black"})
